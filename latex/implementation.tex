...
necessary, tries another location until it has found an empty spot. With this 
approach, we can achieve a packing efficiency of $\sim$50\%, compared to the 
theoretical maximum of $\sim$74\%.
...
distribution of the speed or demonstrate Brownian motion, the results of which 
