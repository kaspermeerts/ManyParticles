...
superlinear complexity is nowhere near as bad as the quadratic complexity 
of the naive implementation, and that it  turns linear again for large 
numbers of particlces.
